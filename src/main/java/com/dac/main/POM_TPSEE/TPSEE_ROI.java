...
public class TPSEE_ROI extends TPSEE_abstractMethods {
	...
	public Date getCurrentfromDate_ROI() throws ParseException, java.text.ParseException {
		...
		System.out.println("The current from date is : " +currentfromDate);
		...
		System.out.println("Final Date after conversion from date is : "+finalcurrentdate);
	...
	public Date getCurrenttoDate_ROI() throws ParseException, java.text.ParseException {
		...
		System.out.println("The current To Date is : "+currenttoDate);
		//String var = ((JavascriptExecutor)driver).executeScript("return window.dateFormat.shortTemplate.PlainHtml").toString();
		//System.out.println("The Date Format is : "+var);
		SimpleDateFormat formats = new SimpleDateFormat("MM/dd/yyyy");
		Date finaltodate = formats.parse(currenttoDate);
		System.out.println("Final Date after conversion To date is : "+finaltodate);
		return finaltodate;
	}
}
