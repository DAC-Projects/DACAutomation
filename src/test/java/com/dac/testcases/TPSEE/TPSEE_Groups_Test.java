...
public class TPSEE_Groups_Test extends BaseClass{
	...
	@SuppressWarnings("unchecked")
	@Test(priority= 3, groups = {"smoke" }, description = "Test to create group")
	...
	@Test(priority= 4, groups = {"smoke" }, description = "Test to view group")
...
//Deleting a Group with 1 Rule
	...
	@Test(priority= 6, groups = {"smoke" }, description = "Test to create multiple criteria with 2 Rules")
    ...
    int i =1;
		...
		Thread.sleep(5000);
		data.two_Rules_Group(Group , Description , CountryField , FilterCondition, Search_Term, CountryField1 , FilterCondition1, Search_Term1, connector);
		
	addEvidence(CurrentState.getDriver(), "Verified Table Data", "yes");
	}		
	
	//Verification of group with 2 rules
			@Test(priority= 7, groups = {"smoke" }, description = "Test to verify two criteria")
			...
			@SuppressWarnings("unchecked")
			@Test(priority= 8, groups = {"smoke" }, description = "Test to delete group")
	        ...
	        int i =1;
				...
				Thread.sleep(5000);
				data.addFilter_Group(Group , Description , CountryField , FilterCondition, Search_Term, CountryField1 , FilterCondition1, Search_Term1, CountryField2 , FilterCondition2, Search_Term2, connector);
				
			addEvidence(CurrentState.getDriver(), "Verified Table Data", "yes");
			}		
			
			//Verification of Group with 3 Rules
			@Test(priority= 10, groups = {"smoke" }, description = "Test to verify multiple criteria with 3 rules")
		...
		@Test(priority= 11, groups = {"smoke" }, description = "Test to edit group")
		...
		TPSEE_Groups s = new TPSEE_Groups(CurrentState.getDriver());
		 int i =1;
			...
			//System.out.println(Group, Group1, Description, CountryField, FilterCondition, Search_Term, CountryField1, FilterCondition1, Search_Term1, CountryField2, FilterCondition2, Search_Term2);
			data.edit_Group(Group, Group1, Description, CountryField, FilterCondition, Search_Term, CountryField1, FilterCondition1, Search_Term1, CountryField2, FilterCondition2, Search_Term2);
		addEvidence(CurrentState.getDriver(), "Verified Table Data", "yes");
		
			
	}
		//Verification of Group with 3 Rules after editing
		@Test(priority= 12, groups = {"smoke" }, description = "Test to verify multiple criteria with 3 rules")
	...
	@SuppressWarnings("unchecked")
	@Test(priority= 13, groups = {"smoke" }, description = "Test to delete group")
