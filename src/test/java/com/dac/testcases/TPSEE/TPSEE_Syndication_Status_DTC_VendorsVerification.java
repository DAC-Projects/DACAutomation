...
/*	*//**
	...
	*//**
	...
	public void verifyDTCVendors() throws Exception {
		...
		for (int k = 5; k <= 5; k++) {
			String LocNum = wb.getCellValue(5, wb.seacrh_pattern("LocationNumber", 0).get(0).intValue());
			System.out.println("The Location Number is :" + LocNum);
			row = data.getLocationNumberRowNum(LocNum);
			System.out.println("The row number is :" + row);
			String vendors = wb.getCellValue(5, wb.seacrh_pattern("Vendors_Create", 0).get(0).intValue());
			...
			String status = wb.getCellValue(5, wb.seacrh_pattern("Status Text", 0).get(0).intValue());
			System.out.println("The status is :" + status);
