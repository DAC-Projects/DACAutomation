...
public class TPSEE_GMB_Test extends BaseClass {
	...
	@Test(priority = 3, groups = { "smoke" }, description = "Verify GMB page loads after filter applied")
	...
	@Test(priority = 4, groups = { "smoke" }, description = "Verify ToolTip Value ")
	...
	@Test(priority = 5, groups = { "smoke" }, description = "Verify CSV Export")
	...
	@Test(priority = 6, groups = { "smoke" }, description = "Verify XLSX Export")
	...
	@Test(priority = 7, groups = { "smoke" }, description = "UI and XL comparision for WebActions")
	...
	@Test(priority = 8, groups = { "smoke" }, description = "UI and XL comparision for Request Directory")
	...
	@Test(priority = 9, groups = { "smoke" }, description = "UI and XL comparision for Phone Calls")
	...
	@Test(priority = 10, groups = { "smoke" }, description = "UI and XL comparision for Total Actions")
	...
	@Test(priority = 11, groups = { "smoke" }, description = "Verify Customer Action UI")
	...
	@Test(priority = 12, groups = { "smoke" }, description = "Verify Customer Web Action UI")
	...
	@Test(priority = 13, groups = { "smoke" }, description = "Verify Customer Req Direct Action UI")
	...
	@Test(priority = 14, groups = { "smoke" }, description = "Verify Customer Phone Action UI")
	...
	@Test(priority = 15, groups = { "smoke" }, description = "Verify Where Listing found UI")
	...
	@Test(priority = 16, groups = { "smoke" }, description = "Verify Where Listing Search found UI")
	...
	@Test(priority = 17, groups = { "smoke" }, description = "Verify Where Listing Map found UI")
	...
	@Test(priority = 18, groups = { "smoke" }, description = "UI and XL comparision for Where Search Listing")
	...
	@Test(priority = 19, groups = { "smoke" }, description = "UI and XL comparision for Where Map Listing")
	...
	@Test(priority = 20, groups = { "smoke" }, description = "UI and XL comparision for Where Total View Listing")
	...
	@Test(priority = 21, groups = { "smoke" }, description = "Verify How Listing found UI")
	...
	@Test(priority = 22, groups = { "smoke" }, description = "Verify How Listing Discovery found UI")
	...
	@Test(priority = 23, groups = { "smoke" }, description = "Verify How Listing Directory found UI")
	...
	@Test(priority = 24, groups = { "smoke" }, description = "Verify How Brand found UI")
	...
	@Test(priority = 25, groups = { "smoke" }, description = "Verify Photo Views UI")
	...
	@Test(priority = 26, groups = { "smoke" }, description = "UI and XL comparision for How Discovery Listing")
	...
	@Test(priority = 27, groups = { "smoke" }, description = "UI and XL comparision for How Direct Listing")
	...
	@Test(priority = 28, groups = { "smoke" }, description = "UI and XL comparision for How Brand Listing")
	...
	@Test(priority = 29, groups = { "smoke" }, description = "UI and XL comparision for How total Listing")
	...
	@Test(priority = 30, groups = { "smoke" }, description = "Verify Owner Photo Views UI")
	...
	@Test(priority = 31, groups = { "smoke" }, description = "Verify Customer Photo Views UI")
	...
	@Test(priority = 32, groups = { "smoke" }, description = "UI and XL comparision for Owner Photo Views")
	...
	@Test(priority = 33, groups = { "smoke" }, description = "UI and XL comparision for Customer Photo Views")
	...
	@Test(priority = 34, groups = { "smoke" }, description = "UI and XL comparision for Total Photo Views")
	...
	@Test(priority = 35, groups = { "smoke" }, description = "Verify Zoom Functionality")
	...
	@Test(priority = 36, enabled = true, dataProvider = "testData")
