...
public class CA_Review_Test extends BaseClass {
	...
	//@Test(priority = 1,  groups= {"smoke"}, description = "Verify Review page loads after filter applied")
	...
	//@Test(priority = 2, groups = {"smoke" }, description = "Test for Review overview export and export verification")
	...
	//@Test(priority = 3, groups = {"smoke" }, description = "Test for verifying tooltips in Review page")
	...
	//@Test(priority = 4, groups = {"smoke" }, description = "Test for comparing Review Site table and overview export values")
	...
	@Test(priority = 5, groups = {"smoke" }, description = "Location Competitor Set Test Evidence Capture with Export")
	...
	@Parameters({ "Filter" })
	@Test(priority = 6, groups = {"smoke" }, description = "Select location for competitor")
